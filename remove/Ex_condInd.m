...
load datasets/simulated/condInd/model.mat
...
rbmInput.epsilonw      = 2e-2;%2e-2 % Learning rate for weights 
rbmInput.epsilonvb     = 2e-2;%2e-2 % Learning rate for biases of visible units 
rbmInput.epsilonhb     = 2e-2;%2e-2 % Learning rate for biases of hidden units 
rbmInput.CD=10;   
rbmInput.initialmomentum  = 0;%0.5;
rbmInput.finalmomentum    = 0.9;%0.9;
rbmInput.maxEpoch = 100;
rbmInput.decayLrAfter = 80; % 40
...
save('conIndResults', 'results', 'M','S');