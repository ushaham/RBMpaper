...
rbmInput.weightPenalty = 1e-1;%1e-1;
weightPenaltyOrg = rbmInput.weightPenalty;
rbmInput.epsilonw      = 0.05;%0.05   % Learning rate for weights 
rbmInput.epsilonvb     = 0.05;%0.05   % Learning rate for biases of visible units 
rbmInput.epsilonhb     = 0.05;%0.05   % Learning rate for biases of hidden units 
rbmInput.CD=1;   
rbmInput.initialmomentum  = 0;%0;
rbmInput.finalmomentum    = 0;%0;
rbmInput.maxEpoch = 1;
...
% S3:
% RBM result (det):0.984
% RBM result (stoch):0.984
% vote result:0.972
% SML result:0.983
% RL result:---
% CORR result:0.984
